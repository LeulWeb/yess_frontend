...
<div className="flex flex-col lg:flex-row justify-start items-start gap-3">
      <div className="lg:w-4/5">
        ...
        <p className='text-[25px] pb-5 md:text-[30px] text-start px-2 sm:px-5 md:px-12 lg:px-28'>Dear all
...
<br/><br/>
#Youtube #Google #Linkedin #Facebook #Telegram #Instagram #Tiktok #whatsapp #wechat
<br/><br/>
