    ...
    <div className='story'>
      <div className="grid grid-cols-1 lg:grid-cols-2">
        <div className="text-center flex items-center justify-center flex-col">
          ...
          <button
            type="button"
            className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  px-10 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-2 my-10 text-[30px] mt-10"
          >
            Address
          </button>
        </div>
