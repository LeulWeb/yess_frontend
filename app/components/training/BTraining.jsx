...
const BTraining =()=>{
    return(
        <div>
            <div className='flex flex-col md:flex-row justify-center items-start gap-20 py-10 px-2 gap-10 sm:px-4 md:px-12 lg:px-24'>
                ...
                <h1 className='text-[#0041ff] font-bold text-[50px] text-center'>Impersonal Skill</h1>
