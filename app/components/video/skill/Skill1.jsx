...
import you from '../../../assets/empoy.png';
        ...
        <div>
            <div className='bg-[#0041ff] flex justify-center items-center flex-col lg:flex-row py-10 gap-10 '>
                <div className='lg:w-3/5'>
                    ...
                    <p className='text-white text-[30px] text-center font-semibold py-4'> Employability skill training equips individuals with essential workplace competencies. Enhancing communication, teamwork, and problem-solving abilities, it boosts professional value, fostering career growth and success in diverse work environments. life.</p>
