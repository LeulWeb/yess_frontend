    ...
    return(
        <div>
            <div className='py-10'>
                ...
                <p className="text-[40px] font-bold text-start px-2 sm:px-6 md:px-12 lg:px-28">Suggestion Spot</p>
           ...
           {news.map((items, index)=>{
            return(
                <div key={index} className="carousel-item shadow-xl border-gray-50 border-2 bg-[#0041ff] w-[300px] rounded-box flex flex-col items-center justify-center h-full pb-10">
                <Image
                  src={footer}
                  alt="Yess News"
                ...
                <div className="  flex flex-col items-center justify-start flex-start">
                  <h1 className="text-white text-[20px] font-semibold text-start -ml-16">lorem lorem lorem lomre</h1>
                </div>
                <p className="text-white text-[10px] text-start pop font-light">
                ...
                <CiCalendarDate size={20}/>
                 <p className="text-xs">Dec 30, 2023</p>
                </div>
