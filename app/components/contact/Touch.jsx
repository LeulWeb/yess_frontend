        ...
        <div className="rounded-2xl border-gray-100 border-2 shadow-lg shadow-gray-100 px-5 py-8 h-[700px] md:h-[550px]">
          <form>
            ...
            <div className="block items-center justify-center">
              <button
                type="submit"
                className="w-44 text-[30px]  mt-10 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg  px-4 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 mx-2"
              >
                Submit
              </button>
            </div>
