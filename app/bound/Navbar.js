...
function Navbar() {
  ...
  return (
    <div className={`sticky top-0 py-2 z-50 bg-white dark:lg:bg-white dark:bg-white ${scrolled ? 'lg:bg-white' : 'dark:bg-white lg:bg-transparent dark:lg:bg-white bg-opacity-20 backdrop-blur-sm'}`}>
