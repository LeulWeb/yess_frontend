...
<div className="flex flex-col lg:flex-row justify-start items-start gap-3">
      <div className="lg:w-4/5">
        ...
        <p className='text-[20px] pb-5  text-start px-2 sm:px-5 md:px-12 lg:px-28'>Greetings from YessEthiopia
<br/>
...
<p className="flex flex-col justify-center text-center items-centre text-[20px] pb-5">For more information, please visit this website <br/>
